  ...
  $(function() {
    ...
    _Life = (function() {
      ...
      _Life.prototype.updateView = function(life) {
        var $collection, $h, done, i, _i, _results;
        $collection = $("#heart .heartCell");
        _results = [];
        for (i = _i = 0; 0 <= _max ? _i < _max : _i > _max; i = 0 <= _max ? ++_i : --_i) {
          if (i < life) {
            _results.push($collection.eq(i).toggleClass('hurt', false));
          } else {
            $h = $collection.eq(i);
            ...
            _results.push($h.toggleClass('hurt', true));
          }
        }
        return _results;
      };
    ...
    _Time = (function() {
      var $timeTextView, $timeView, Main, THIS, t, _countLoop, _time;
    ...
    _Board = (function() {
      ...
      _Board.prototype.half = function() {
        var $ballons, arr, eliminateArr, eliminateLength, length, v, _i, _results;
    ...
    GameController = (function() {
      var Audio, Board, Data, Life, Page, Question, Score, THIS, Timer, gamming, questionDataList, _funcStatus, _initFuncStatus, _initSubControllers;
